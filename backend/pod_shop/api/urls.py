...
urlpatterns = [
    ...
    path('cms/site-content/section/<path:section_path>/',
        cms_content_views.cms_content_section_get_view, name='cms_content_section_get_api'),
    path('cms/site-content/section/<path:section_path>/save/',
        cms_content_views.cms_content_section_set_view, name='cms_content_section_set_api'),
    path('cms/hero-slides/',
        cms_content_views.hero_slider_list_view, name='hero_slider_list_api'),
    path('cms/hero-slides/<int:slide_id>/',
        cms_content_views.hero_slider_detail_view, name='hero_slider_detail_api'),
    ...
    path('admin-products/<int:pk>/',
        product_admin.admin_product_detail, name='admin_product_detail_api'),
    ...
    path('admin-brands/<int:pk>/',
        brand_admin.admin_brand_detail, name='admin_brand_detail_api'),
    ...
    path('admin-categories/<int:pk>/',
        category_admin.admin_category_detail, name='admin_category_detail_api'),
