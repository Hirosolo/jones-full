"""
URL configuration for fulfillnext project.
...
urlpatterns = [
    ...
    path('admin/products/<int:pk>/delete', admin_product_delete_view, name='admin_product_delete'),
