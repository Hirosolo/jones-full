...
# COOKIE_DOMAIN env (e.g. ".fulfillnext.com" to share sessions across
...
ROOT_URLCONF = 'fulfillnext.urls'

WSGI_APPLICATION = 'fulfillnext.wsgi.application'
...
#   fulfillnext.com/admin/uploads/:path*  →  storage.googleapis.com/<bucket>/:path*
...
if GS_BUCKET_NAME:
    ...
    GS_CUSTOM_ENDPOINT = config(
        'GS_CUSTOM_ENDPOINT',
        default='https://fulfillnext.com/images',
    )
    ...
    STORAGES = {
        ...
        'default': {'BACKEND': 'fulfillnext.storage.SequentialFileSystemStorage'},
        'staticfiles': {
            'BACKEND': 'whitenoise.storage.CompressedManifestStaticFilesStorage',
        },
    }
...
NEXTJS_JWT_KEY_NAME = 'fulfillnext_jwt'
NEXTJS_REFRESH_TOKEN_KEY_NAME = 'fulfillnext_refresh'
