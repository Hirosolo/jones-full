...
```
fulfillnext.com       → Vercel (Frontend)
api.fulfillnext.com   → Cloud Run (Backend API)
```
...
- `SITE_URL` — https://fulfillnext.com
- `DJANGO_BASE_URL` — https://api.fulfillnext.com
- `CORS_ALLOWED_ORIGINS` — https://fulfillnext.com
- `GS_BUCKET_NAME` — Media storage bucket

**Frontend (Vercel):**
- `NEXT_PUBLIC_DJANGO_BASE_URL` — https://api.fulfillnext.com
- `NEXT_PUBLIC_SITE_URL` — https://fulfillnext.com
