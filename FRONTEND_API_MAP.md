...
| Product detail page | `jones/pages/product/[productSlug].tsx`, `jones/src/components/products/ProductDetails.tsx`, `jones/src/components/products/ProductGallery.tsx`, `jones/src/components/reviews/index.tsx` | `productsApi`, `wishlistApi`, `reviewsApi` | `/api/shop/product-detail/`, `/api/shop/check-item-wishlist/`, `/api/shop/action-to-wishlist/`, `/api/shop/product-review/`, `/api/shop/product-review-create/` | Product details, gallery images, wishlist state, related products, and review loading/submission |
| Product review form | `jones/src/components/reviews/index.tsx` | `productsApi`, `reviewsApi` | `/api/shop/product-review/`, `/api/shop/product-review-create/` | Listing and submitting product reviews on the product detail page |
